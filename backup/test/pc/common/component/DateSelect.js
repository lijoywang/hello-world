...
define(function (require, exports, module) {
    ...
    return Ractive.extend({
        template: require('tpl!./DateSelect.html'),
        data: function () {
            return {
                ...
                options: {
                    ...
                    sofar: true,
                    cleanChildrenOnParentChange: true,
        ...
        oninit: function () {
            ...
            var cleanChildrenOnParentChange = me.get('cleanChildrenOnParentChange');
            ...
            if (hasYear) {
                ...
                me.set({
                    ...
                    'options.year.onselect': function () {
                        if (cleanChildrenOnParentChange) {
                            var data = { };
                            if (hasMonth) {
            ...
            if (hasMonth && hasDate && cleanChildrenOnParentChange) {
