...
var jsBuild = function (ast, fileName) {
    ...
    writeTask.write(
        biz.getReleaseMd5Name(fileName,minjs),
        minjs
    );
};
...
var filterFile = function (dependencyMap) {
    ...
    util.each(
        ...
        function (item, key) {
            ...
            else if (/loader\.js$/ig.test(item.fileName)) {
