...
define(function (require, exports) {
    ...
    if (baseOrigin.indexOf('.m.genshuixue.com') > -1) {
        baseOrigin = "http://m.genshuixue.com";
    }
    ...
    function NevPanel(options) {
        ...
        if (!mainPanel.length) {
            ...
            util_dom.insertCssText(cssNevPanel);
            ...
            window.gsx_ready(function (config) {
                var userImg = "http://img.gsxservice.com/0cms/d/file/content/2015/09/55ecf79513d9d.png";
                if (config.user) {
                ...
                userImgDom.attr({'data-src': userImg, 'width': '100%', 'height':'auto', 'whs':1});
    ...
    util_base.inherits(NevPanel, MVCObject);
