...
define(function (require, exports) {
    ...
    var postUrl = "http://pb0.genshuixue.com/gs.gif";
    ...
    */
    return function (options) {
        ...
        if(!userCookie){
            ...
            body.append(smsHtml + "<img src='http://img.gsxservice.com/0cms/d/file/content/2016/05/57307f165129a.png'  class='freeZiliao' style='display:block;position:fixed;height:50px;width:50px;right:4px;top:50%;' /></a>");
            ...
            var tanHtml =  '<div class="fuceng" style="position:fixed;width:280px;height:200px;top:-25%;right:0;left:0;bottom:0;margin:auto;">'
                        ...
                        +'<img src="http://img.gsxservice.com/0cms/d/file/content/2016/05/57307f15a71f5.png" style="position:absolute;height:180px;width:100%;z-index:4;top:-10px;left:0" class="close_button_img"/>'
                        +'<div style="height:200px;width:100%;background:white;bottom:10px;margin-top:130px;text-align:center;border-radius:6px">'
                            ...
                            +smsHtml
                                +'<img src="http://img.gsxservice.com/0cms/d/file/content/2016/05/57307f1630180.png" style="height:50px;width:240px;margin-top:-10%;" class="button_close_img" />'
                            +'</a>'
                        +'</div>'
                        +'</div>';
            ...
            var body = $("body");
            body.append(smsHtml + "<img src='http://img.gsxservice.com/0cms/d/file/content/2016/05/57306d367c65a.png'  class='freeZiliao' style='display:block;position:fixed;height:50px;width:50px;right:4px;top:50%;' /></a>");
        }
        //领取资料上报
