...
define(function (require, exports) {
    ...
    var tpl_text = '<div class="bubble"><div class="bubble_body"><div class="plain"><pre></pre><img class="ico_loading" style="display:none" src="' + require.toUrl("page/IM/imgs/icon_loading.gif") + '" /><i class="icon-notice" style="display:none;"></i></div></div></div>';
    ...
    Render['text'] = function (messageInfo, options, instance) {
        ...
        $wrap.find('pre').text(messageData.content);
